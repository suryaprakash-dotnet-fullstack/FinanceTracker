        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RolloverEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
                    Notes = table.Column<string>(type: "TEXT", nullable: true),
                    UserId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "#10b981", "💼", true, "Salary", 0, null },
                    { 2, "#06b6d4", "💻", true, "Freelance", 0, null },
                    { 3, "#8b5cf6", "📈", true, "Investment Returns", 0, null },
                    { 4, "#f59e0b", "🍔", true, "Food & Dining", 1, null },
                    { 5, "#ef4444", "🚗", true, "Transportation", 1, null },
                    { 6, "#ec4899", "🛍️", true, "Shopping", 1, null },
                    { 7, "#6366f1", "🏠", true, "Housing & Rent", 1, null },
                    { 8, "#f97316", "💡", true, "Utilities", 1, null },
                    { 9, "#14b8a6", "🏥", true, "Healthcare", 1, null },
                    { 10, "#a855f7", "🎬", true, "Entertainment", 1, null },
                    { 11, "#3b82f6", "📚", true, "Education", 1, null },
                    { 12, "#06b6d4", "✈️", true, "Travel", 1, null },
                    { 13, "#10b981", "🏦", true, "Savings", 1, null },
                    { 14, "#64748b", "🛡️", true, "Insurance", 1, null },
                    { 15, "#94a3b8", "🔄", true, "Transfer", 2, null }
                });
